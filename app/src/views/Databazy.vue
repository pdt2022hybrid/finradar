    ...
    <div class="mb-40">
        <div class="flex-col lg:mt-16 flex items-center font-rubik w-full">
            <div class="w-4/5">
                ...
                <h3 class="text-xl font-bold mb-4 indent-8">
                    Filtrovanie v databáze
                </h3>
            </div>
        </div>
        <div class="flex flex-col items-center">
            <div class="flex-col flex w-3/4">
                <div
                    v-if="mobile"
                    class="lg:hidden bg-tables border p-0.5"
                    @click="mobile = !mobile"
                >
                ...
                <transition>
                    <div
                        v-if="mobile === false"
                        class="border bg-tables flex lg:flex-row flex-col p-6"
                    >
                        ...
                        >
                            <button
                                class="w-3/5 bg-green p-1.5 rounded text-dark hover:border-light hover:border-2 font-varela lg:h-1/3"
                                @click="Search"
                            >
                                Hľadaj
                            </button>
                ...
                <table class="bg-tables border-x w-full font-varela mb-20">
                    ...
                    <tbody v-else>
                        <tr v-for="item in companies.data">
                            ...
                            <td class="border-r tab text-center w-1/6">
                                {{ item.latest_data.revenue }} €
                            </td>
                            <td class="text-center border-r tab w-1/6">
                ...
                >
                    <div>
                        <button
                            class="focused p-3 bg-tables rounded-tl-lg rounded-bl-lg border"
                            @click="Search((page = 1))"
                        >
                            <i class="bi bi-chevron-double-left"></i>
                        </button>
                        <button
                            class="focused p-3 bg-tables border-y"
                            @click="Search(page--)"
                        >
                        ...
                        <input
                            ...
                            min="1"
                            class="p-3 bg-tables text-center border"
                        ...
                        <button
                            class="focused p-3 bg-tables rounded-tr-lg rounded-br-lg border"
                            @click="Search((page = companies.meta.last_page))"
                        >

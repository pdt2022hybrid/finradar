        ...
        <div class="homepageHeader mb-48">
            <div class="main-focus">
                ...
                <div>
                    <input
                        type="text"
                        class="header-input placeholder-dark placeholder:mx-auto placeholder:font-varela font-varela focus:outline-none focus:ring-2 focus:border-background focus:ring-sky focus:shadow-2xl shadow-2xls focus:placeholder-blue"
                        v-model="name"
...
@layer base {
    ...
    .homepageHeader {
        @apply lg:items-center text-center w-full;
    }
    ...
    .header-input {
        @apply pl-5 text-left items-center mt-20 w-64 lg:w-3/12 h-10 rounded-lg bg-white lg:h-12 border-dark border-2 shadow-2xl;
    }

    .homepageMainContent {
        @apply flex items-center flex-col lg:flex-row lg:place-content-evenly h-fit py-16 bg-white;
    }
    ...
    .main-focus {
        @apply bg-gradient-to-bl from-gre1 to-gre2 pt-36 pb-32;

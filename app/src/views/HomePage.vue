        ...
        <div class="homepageHeader mb-48">
            ...
            <div class="flex justify-center" v-if="name !== ''">
                <ul class="absolute w-64 bg-light rounded-md mx-auto z-10 -mt-2.5">
                    <li v-for="item in companies" class="border-background border-b-2 p-1.5">
                        <router-link :to="{ name: 'company', params: { ico: item.ico } }" v-slot="{ redirect }">
                            <h4 class="cursor-pointer lg:w-fit mx-auto font-varela font-medium hover:font-semibold active:text-blue"
        ...
        <ul class="homepageMainContent">
            <li class="mainContentText">
                ...
                <p>Sme váš zdroj pre aktuálne finančné štatistiky a poznatky!
                    FinRadar ako online platforma poskytuje komplexné a spoľahlivé informácie o rôznych finančných
                    ukazovateľoch a analýze údajov.
                    Bez ohľadu na to, či ste investor, obchodný profesionál alebo len záujemca o finančný svet, FinRadar
                    je váš zdroj pre všetko súvisiace s finančnými štatistikami.
                </p>
            </li>
            <li>
            ...
            <li class="mainContentText">
                ...
                <p>FinRadar vám poskytuje všetko, čo potrebujete. Od interaktívnych grafov až po nekonečné databázy
                    ...
                    úspech v komplexnom svete financií.
                    Pripojte sa k nám na tejto finančnej ceste a odomknite moc dát s FinRadarom, najlepším zdrojom pre
